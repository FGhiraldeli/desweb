...
class TQuestion
{
    ...
    * @param  $action_yes = acao para reposta positiva
    * @param  $action_no  = acao para resposta negativa
    */
   function __construct($message, TAction $action_yes, TAction $action_no)
   {
      ...
      // cria um botao para resposta negativa
