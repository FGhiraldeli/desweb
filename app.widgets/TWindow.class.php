...
/**
 * classe TWindow
 * TWindow é um conteiner que exibe seu conteúdo em ma camada simulando uma janela
 */
class TWindow
{
   private $x;          // coluna
   ...
   public function show()
   {
      ...
      // de posicionamento e dimensao da camada criada
      ...
      // cria um link com acao para esconder o <div>
      $link = new TElement('a');
